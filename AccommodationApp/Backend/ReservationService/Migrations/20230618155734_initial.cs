        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccommodationId = table.Column<string>(type: "text", nullable: true),
                    AccommodationName = table.Column<string>(type: "text", nullable: true),
                    AccommodationLocaiton = table.Column<string>(type: "text", nullable: true),
                    HostId = table.Column<string>(type: "text", nullable: true),
                    NumberOfGuests = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "AccommodationId", "AccommodationLocaiton", "AccommodationName", "From", "HostId", "NumberOfGuests", "Price", "Status", "To", "UserId" },
                values: new object[] { "1", "643455b8941a49684fb8cfc1", null, null, new DateTime(2023, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 10, 0.0, 0, new DateTime(2023, 5, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "7bf59c03-17a6-49a9-92f1-4c251b0d0bd8" });
        }
